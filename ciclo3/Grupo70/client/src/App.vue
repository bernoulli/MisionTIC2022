...
export default {
  ...
  methods: {
    addToDo() {
      axios
        .post("https://dry-refuge-57753.herokuapp.com/todo/add", {
          todo: this.newTodo
        })
        .then(response => {
    ...
    completeTodo(todoID) {
      axios
        .post("https://dry-refuge-57753.herokuapp.com/todo/complete/" + todoID)
        .then(response => {
          console.log(response.data);
        });
    },
    deleteTodo(todoID) {
      axios.delete("https://dry-refuge-57753.herokuapp.com/todo/" + todoID).then(response => {
        console.log(response.data);
      });
    }
  },
  created() {
    ...
    axios
      .get("https://dry-refuge-57753.herokuapp.com/todo/uncompleted")
      .then(response => (this.uncompletedTodos = response.data))
      .catch(error => console.log(error));
    // fetch completed task
    axios
      .get("https://dry-refuge-57753.herokuapp.com/todo/completed")
